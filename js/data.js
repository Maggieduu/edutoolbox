...
const SITE_DATA = {
    ...
    translations: {
        zh: {
            ...
            game5Title: '疯狂的句子',
            game5TitleEn: 'Scrambled',
            game5Desc: '组合正确句子',
            game5DescFull: '把词语按照正确的顺序组合成句子',
            game6Title: '背单词游戏',
            game6TitleEn: 'Vocabulary Builder',
            game6Desc: '四种模式背单词',
            game6DescFull: '四种模式轻松背单词：选择题、填空题、连连看、限时赛。科学的复习系统帮助你高效记忆词汇。',
            game7Title: '找朋友',
            game7TitleEn: 'Chinese',
            game7Desc: '学习部首含义',
            game7DescFull: '通过字形字义找朋友，学习汉字部首和含义',

            // Tools
            tool1Title: '汉字大侦探',
            tool1TitleEn: 'Generator',
        ...
        en: {
            ...
            game1Title: 'Gomoku',
            game1TitleEn: '',
            game1Desc: 'Review synonyms',
            game1DescFull: 'Review synonyms and antonyms through Gomoku gameplay',
            game2Title: 'Word Detective',
            game2TitleEn: '',
            game2Desc: 'Word search puzzles',
            game2DescFull: 'Play word search puzzles online and challenge your vocabulary',
            game3Title: 'Words Match',
            game3TitleEn: '',
            game3Desc: 'Flip cards to learn',
            game3DescFull: 'Reinforce vocabulary memory through card flipping',
            game4Title: 'Gluttonous Snake',
            game4TitleEn: '',
            game4Desc: 'Eat wrong words',
            game4DescFull: 'Eat the wrong words and compete for high scores',
            game5Title: 'Scrambled Sentences',
            game5TitleEn: '',
            game5Desc: 'Arrange sentences',
            game5DescFull: 'Arrange words into correct sentence order',
            game6Title: 'Vocabulary Builder',
            game6TitleEn: '',
            game6Desc: '4 modes',
            game6DescFull: '4 modes: Multiple choice, Fill-in, Match, Timed Challenge',
            game7Title: 'Find Your Match',
            game7TitleEn: '',
            game7Desc: 'Learn radicals',
            game7DescFull: 'Learn Chinese radicals and meanings through character matching',

            tool1Title: 'Word Detective',
            tool1TitleEn: 'Generator',
